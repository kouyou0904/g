...
{
    private static readonly string filePath = "Assets/Resources/Date/Status.xlsx";
    private static readonly string[] sheetNames = { "Status", };
    ...
    static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
    {
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                ...
                {
                    var exportPath = "Assets/Resources/Date/" + sheetName + ".asset";
                    
                    // check scriptable object
                    var data = (Entity_Status)AssetDatabase.LoadAssetAtPath(exportPath, typeof(Entity_Status));
                    if (data == null)
                    {
                        data = ScriptableObject.CreateInstance<Entity_Status>();
